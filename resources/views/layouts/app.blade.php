...
<body>
    <div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
        ...
        <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
            ...
            <li class="nav-group"><a class="nav-link nav-group-toggle" href="{{ route('logout') }}">
                    <svg class="nav-icon">
    ...
    {{-- <script src="https://cdn.jsdelivr.net/npm/@coreui/coreui-pro@4.6.4/dist/js/coreui.bundle.min.js"
        integrity="sha384-J57aCZcRcbraFuQaL18wp1fDE0fLyO7Il/jKACMovk4ddxUIvjRK5ZZnqcHuBF/T" crossorigin="anonymous">
    </script> --}}
    ...
    <script src="https://cdn.jsdelivr.net/npm/@coreui/coreui@4.3.2/dist/js/coreui.min.js"
        integrity="sha384-aSKS9XOpUPpbt04gdmvW98xQixHuU0EpjTi4UM/qEg13Aupu+G/Vbj00+1XwcPc1" crossorigin="anonymous">
    </script>
    or
    <script src="https://cdn.jsdelivr.net/npm/@coreui/coreui-pro@4.6.4/dist/js/coreui.min.js"
        integrity="sha384-L1mWJn9N4HqxHIDx4qQkKSx67qI1CDjsgZeprk6NFYd7xUaWyYjNGWAcTjhlEf/u" crossorigin="anonymous">
    </script>
    -->
</body>
